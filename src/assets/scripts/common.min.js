...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (document.querySelector(".ui-background-motion")) {
    ...
    el.forEach((element) => {
      ...
      element.addEventListener("mouseenter", (event) => {
        ...
        element.closest(".plan-list").classList.add("active");
      });
      element.addEventListener("mouseleave", (event) => {
        createBg.style.left = event.layerX + "px";
        createBg.style.top = event.layerY + "px";
        createBg.classList.remove("active");
        element.closest(".plan-list").classList.remove("active");
      });
    });
  }
  ...
  if (document.querySelector(".btn-menu")) {
    ...
    document.querySelectorAll(".mo-menu").forEach(($el) => {
      $el.addEventListener("click", () => {
        menu.style.left = 100 + "%";
        setTimeout(() => {
          menu.style.display = "none";
  ...
  if (document.querySelector("[data-scroll]")) {
    ...
    btns.forEach(($el) => {
      $el.addEventListener("click", () => {
        const top = document.querySelector($el.dataset.scroll).offsetTop;
        window.scroll({
          top,
          behavior: "smooth",
          duration: 500,
